    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <?php echo checkAdminNotSignOut() ?  "<li><a class='dropdown-item' href='?module=admin&page=manage/list'>User management</a></li>" : null; ?>
          
            <li><a class="dropdown-item" href="?module=user&page=profile/profile&id=<?php echo $userId ?>">Profile settings</a></li>
