        ...
        <div class="card chat-app">
            <div id="plist" class="people-list">
                ...
                <?php
                    ...
                    ?>
                    <li class="clearfix">
                    <a href="?module=user&page=profile/profileView&userId=<?php echo $userId ?>"><img src="<?php echo $item['profileImage'] ? $item['profileImage'] :  "https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?w=826&t=st=1710127291~exp=1710127891~hmac=10efc92f9bddd8afe06fa86d74c0caf109f33b79794fd0fc982a01c8bff70758"; ?>" class="mr-3 rounded-circle" width="50" alt="User" /></a>
                        <div class="about">
                            <div class="name"><a href="?module=user&page=profile/profileView&userId=<?php echo $userId ?>" class="text-body"><?php echo $item['fullname'] ?></a></div>
