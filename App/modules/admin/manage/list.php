    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<?php echo _WEB_HOST;?>/?module=admin&page=manage/delete&id=<?php echo $item['id']?>" onclick="return confirm('Delete this row?')" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a></td>
            </tr>
